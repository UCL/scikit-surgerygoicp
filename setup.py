...
#   SKSURGERYGOICP_PYTHON_MODULE_NAME to give the output python module the correct name.
#   SKSURGERYGOICP_PYTHON_OUTPUT_DIRECTORY to produce the output python module in the correct place
...
class CMakeExtension(Extension):
    def __init__(self, name, sourcedir=''):
        ...
        self.build_dir = os.path.join(self.super_build_dir, 'SKSURGERYGOICP-build')
...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        cmake_args = ['-DSKSURGERYGOICP_PYTHON_OUTPUT_DIRECTORY:PATH=' + ext_dir,
                      '-DSKSURGERYGOICP_PYTHON_MODULE_NAME:STRING=' + ext.name
                      ]
        build_args = []
...
setup(
    ...
    ext_modules=[CMakeExtension('sksurgerygoicppython', sourcedir=dir_path)],
