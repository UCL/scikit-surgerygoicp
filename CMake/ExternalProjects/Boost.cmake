...
set(SKSURGERYGOICP_USE_Boost 1)
set(SKSURGERYGOICP_USE_Boost_LIBRARIES ${SKSURGERYGOICP_BOOST_LIBS})
set(SKSURGERYGOICP_BUILD_PYTHON_BINDINGS OFF)
...
string(REPLACE "^^" ";" SKSURGERYGOICP_USE_Boost_LIBRARIES "${SKSURGERYGOICP_USE_Boost_LIBRARIES}")

if(NOT DEFINED BOOST_ROOT AND NOT SKSURGERYGOICP_USE_SYSTEM_Boost)
  ...
  if(SKSURGERYGOICP_USE_Boost_LIBRARIES)
    string(REPLACE ";" "," _boost_libs "${SKSURGERYGOICP_USE_Boost_LIBRARIES}")
    foreach(_boost_lib ${SKSURGERYGOICP_USE_Boost_LIBRARIES})
	  ...
	  if("${_boost_lib}" STREQUAL "python" OR "${_boost_lib}" STREQUAL "python${PYTHON_VERSION_MAJOR}${PYTHON_VERSION_MINOR}")
	    set(SKSURGERYGOICP_BUILD_PYTHON_BINDINGS ON)
	  endif()
    endforeach()
  endif()
  ...
  if(SKSURGERYGOICP_BUILD_PYTHON_BINDINGS)
  ...
  set(_boost_cxxflags )
  if(CMAKE_CXX_FLAGS OR SKSURGERYGOICP_CXX11_FLAG OR PythonLibs_FOUND)
    set(_boost_cxxflags "cxxflags=${SKSURGERYGOICP_CXX11_FLAG} ${CMAKE_CXX_FLAGS}")
    if(WIN32)
  ...
  set(SKSURGERYGOICP_PREFIX_PATH ${proj_INSTALL}^^${SKSURGERYGOICP_PREFIX_PATH})
  ...
  # Manual install commands (for a SKSURGERYGOICP super-build install)
