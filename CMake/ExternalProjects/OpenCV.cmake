...
if(NOT DEFINED OpenCV_DIR)
  ...
  set(_cuda_options
    -DWITH_CUDA:BOOL=${SKSURGERYGOICP_USE_CUDA}
  )
  if(SKSURGERYGOICP_USE_CUDA)
    list(APPEND _cuda_options
      -DCUDA_TOOLKIT_ROOT_DIR:PATH=${CUDA_TOOLKIT_ROOT_DIR}
      -DCUDA_ARCH_BIN:STRING=${SKSURGERYGOICP_CUDA_ARCH_BIN}
      -DCUDA_PROPAGATE_HOST_FLAGS:BOOL=OFF
    )
    if(CMAKE_COMPILER_IS_GNUCXX)
      list(APPEND _cuda_options -DCUDA_NVCC_FLAGS:STRING=${SKSURGERYGOICP_CXX11_FLAG}^^--expt-relaxed-constexpr)
    else()
      list(APPEND _cuda_options -DCUDA_NVCC_FLAGS:STRING=${SKSURGERYGOICP_CXX11_FLAG})
    endif()
  endif()
  ...
  ExternalProject_Add(${proj}
    ...
    CMAKE_ARGS
      ...
      ${_additional_options}
      ${_cuda_options}
      "-DCMAKE_CXX_FLAGS:STRING=${CMAKE_CXX_FLAGS} ${SKSURGERYGOICP_CXX11_FLAG} -DVTK_MAJOR_VERSION=6" # Doesn't matter what version, as long as > 5.
