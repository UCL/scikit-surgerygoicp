...
set(SKSURGERYGOICP_PACKAGE_NAME "sksurgerygoicp" CACHE STRING "")
if(WIN32)
  set(SKSURGERYGOICP_BASE_NAME "sksurgerygoicp" CACHE STRING "")
else()
  set(SKSURGERYGOICP_BASE_NAME "sksurgerygoicp" CACHE STRING "")
endif()
set(SKSURGERYGOICP_VERSION_STRING "${SKSURGERYGOICP_VERSION_MAJOR}.${SKSURGERYGOICP_VERSION_MINOR}.${SKSURGERYGOICP_VERSION_PATCH}" CACHE STRING "String to describe fully named version" FORCE)
set(SKSURGERYGOICP_DEPLOY_NAME "${SKSURGERYGOICP_BASE_NAME}-${SKSURGERYGOICP_VERSION_STRING}" CACHE STRING "" FORCE)
set(SKSURGERYGOICP_CONTACT "Your Name Here <your@email.com>" CACHE STRING "")
...
configure_file(${CMAKE_SOURCE_DIR}/CMake/CPackOptions.cmake.in
               ${CMAKE_BINARY_DIR}/SKSURGERYGOICPCPackOptions.cmake @ONLY IMMEDIATE)

# 4. Set a variable with the name of this file.
set(CPACK_PROJECT_CONFIG_FILE "${CMAKE_BINARY_DIR}/SKSURGERYGOICPCPackOptions.cmake")

# 5. Include this optional file.
include(SKSURGERYGOICPCPackOptions)
