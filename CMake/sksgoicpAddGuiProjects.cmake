...
if(BUILD_QtVTKDemo AND NOT SKSURGERYGOICP_USE_QT)
  set(SKSURGERYGOICP_USE_QT ON CACHE BOOL "Use Qt." FORCE)
  message("Forcing SKSURGERYGOICP_USE_QT to ON due to BUILD_QtVTKDemo being ON.")
endif()
...
if(BUILD_QMLVTKDemo AND NOT SKSURGERYGOICP_USE_QT)
  set(SKSURGERYGOICP_USE_QT ON CACHE BOOL "Use Qt." FORCE)
  message("Forcing SKSURGERYGOICP_USE_QT to ON due to BUILD_QMLVTKDemo being ON.")
endif()
...
if(BUILD_QOpenGLDemo AND NOT SKSURGERYGOICP_USE_QT)
  set(SKSURGERYGOICP_USE_QT ON CACHE BOOL "Use Qt." FORCE)
  message("Forcing SKSURGERYGOICP_USE_QT to ON due to BUILD_QOpenGLDemo being ON.")
endif()

if(NOT BUILD_QOpenGLDemo AND NOT BUILD_QMLVTKDemo AND NOT BUILD_QtVTKDemo AND SKSURGERYGOICP_USE_QT)
	set(SKSURGERYGOICP_USE_QT OFF CACHE BOOL "Use Qt." FORCE)
  message("Setting SKSURGERYGOICP_USE_QT to OFF as nothing requires it")
endif()
...
set_property(GLOBAL PROPERTY SKSURGERYGOICP_GUI_APPS ${_known_apps})
