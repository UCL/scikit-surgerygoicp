...
mitkFunctionGetVersion(${CMAKE_SOURCE_DIR} SKSURGERYGOICP)
niftkMacroGetGitDateTime(${CMAKE_SOURCE_DIR} SKSURGERYGOICP)
niftkMacroGetGitBranch(${CMAKE_SOURCE_DIR} SKSURGERYGOICP)
...
if(CMAKE_GENERATOR MATCHES Make AND NOT (CMAKE_GENERATOR MATCHES NMake) )
  ...
  set(CTBN "${osname}-${cpu}-${CompilerName}-${CMAKE_CXX_COMPILER_VERSION}-${SKSURGERYGOICP_BRANCH_NAME}-${SKSURGERYGOICP_REVISION_SHORTID}")

else()

  set(CTBN "${CMAKE_GENERATOR}-${SKSURGERYGOICP_BRANCH_NAME}-${SKSURGERYGOICP_REVISION_SHORTID}")
...
message(STATUS "scikit-surgeryopencvcpp branch=${SKSURGERYGOICP_BRANCH_NAME}")
message(STATUS "scikit-surgeryopencvcpp version=${SKSURGERYGOICP_REVISION_SHORTID}")
message(STATUS "scikit-surgeryopencvcpp date=${SKSURGERYGOICP_DATE_TIME}")
...
if(BUILD_TESTING)
  set(BUILDNAME "SKSURGERYGOICP" CACHE STRING "Name of build on the dashboard")
  mark_as_advanced(BUILDNAME)
