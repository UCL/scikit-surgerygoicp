...
# This allows switching branches in the SKSURGERYGOICP source code and build SKSURGERYGOICP quickly, even if the
...
# SKSURGERYGOICP-configure timestamp manually before doing a superbuild. Without that the CMake cache is
...
set(EP_COMMON_ARGS
  ...
  "-DCMAKE_CXX_FLAGS:STRING=${CMAKE_CXX_FLAGS} ${SKSURGERYGOICP_CXX11_FLAG}"
  #debug flags
...
set(SKSURGERYGOICP_SUPERBUILD_DEBUG_POSTFIX d)
...
######################################################################
include(sksgoicpExternalProjectHelperMacros)
...
######################################################################
# Now compile SKSURGERYGOICP, using the packages we just provided.
######################################################################
if(NOT DEFINED SUPERBUILD_EXCLUDE_SKSURGERYGOICPBUILD_TARGET OR NOT SUPERBUILD_EXCLUDE_SKSURGERYGOICPBUILD_TARGET)
  ...
  ExternalProject_Add(${proj}
    ...
    CMAKE_ARGS
      ...
      -DCMAKE_PREFIX_PATH:PATH=${SKSURGERYGOICP_PREFIX_PATH}
      -DSKSURGERYGOICP_SUPERBUILD_DEBUG_POSTFIX:STRING=${SKSURGERYGOICP_SUPERBUILD_DEBUG_POSTFIX}
    CMAKE_CACHE_ARGS
      ${EP_COMMON_CACHE_ARGS}
      -DCMAKE_LIBRARY_PATH:PATH=${CMAKE_LIBRARY_PATH}
      -DCMAKE_INCLUDE_PATH:PATH=${CMAKE_INCLUDE_PATH}
      -DSKSURGERYGOICP_EXTERNAL_PROJECT_PREFIX:PATH=${ep_prefix}
      -DSKSURGERYGOICP_USE_KWSTYLE:BOOL=${SKSURGERYGOICP_USE_KWSTYLE}
      -DSKSURGERYGOICP_USE_CPPCHECK:BOOL=${SKSURGERYGOICP_USE_CPPCHECK}
      -DSKSURGERYGOICP_USE_QT:BOOL=${SKSURGERYGOICP_USE_QT}
      -DSKSURGERYGOICP_USE_OPENMP:BOOL=${SKSURGERYGOICP_USE_OPENMP}
      -DSKSURGERYGOICP_USE_CUDA:BOOL=${SKSURGERYGOICP_USE_CUDA}
      -DSKSURGERYGOICP_DELAYLOAD_CUDA:BOOL=${SKSURGERYGOICP_DELAYLOAD_CUDA}
      -DSKSURGERYGOICP_CUDA_ARCH_BIN:STRING=${SKSURGERYGOICP_CUDA_ARCH_BIN}
      -DCUDA_TOOLKIT_ROOT_DIR:PATH=${CUDA_TOOLKIT_ROOT_DIR}
      -DSKSURGERYGOICP_USE_MPI:BOOL=${SKSURGERYGOICP_USE_MPI}
      -DCMAKE_INSTALL_PREFIX:PATH=${CMAKE_INSTALL_PREFIX}
      "-DCMAKE_INSTALL_RPATH:STRING=${_install_rpath}"
      -DCMAKE_VERBOSE_MAKEFILE:BOOL=${CMAKE_VERBOSE_MAKEFILE}
      -DBUILD_TESTING:BOOL=${BUILD_TESTING} # The value set in EP_COMMON_ARGS normally forces this off, but we may need SKSURGERYGOICP to be on.
      ...
      -DSKSURGERYGOICP_PYTHON_VERSION:STRING=${SKSURGERYGOICP_PYTHON_VERSION}
      -DBUILD_UNITY_WRAPPER:BOOL=${BUILD_UNITY_WRAPPER}
      -DSKSURGERYGOICP_UNITY_PLUGIN_DIR:PATH=${SKSURGERYGOICP_UNITY_PLUGIN_DIR}
